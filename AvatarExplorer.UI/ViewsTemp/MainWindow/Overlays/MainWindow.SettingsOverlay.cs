...
public partial class MainWindow
{
    ...
    private void SettingsOverlay_Close()
    {
    ...
    private async void SettingsOverlay_UpdateCheckNow_Click(object? sender, RoutedEventArgs e)
    {
        // await UpdateDialogOverlay_CheckAsync((UpdateChannel)SettingsOverlay_UpdateChannelComboBox.SelectedIndex, false);
    }
