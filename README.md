...
このプロジェクトへの貢献時に AI ツール（GitHub Copilot など）を利用する場合、以下のガイドラインを守ってください。

**許可される使用方法**:
- ✅ 関数やメソッドの**一部**を書かせる
- ✅ **ロジックの補完**やスニペット生成の利用
- ✅ GitHub Actions など、**ソフトウェアの動作に直接関係ない部分**（ドキュメント、ビルドスクリプト、CI/CD など）

**禁止される使用方法**:
- ❌ 関数**全体**や**メソッド全体**を生成させる
- ❌ ファイル**全体**を AI に書かせる

**重要**:
AI が生成したコードであっても、**すべてのコード変更は、あなたの目で必ずレビュー・検証してください**。バグの混入を防ぎ、プロジェクトの品質を維持するためです。
